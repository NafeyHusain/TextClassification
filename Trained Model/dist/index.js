...
exports.load = load;
var ToxicityClassifier = /** @class */ (function () {
    ...
    ToxicityClassifier.prototype.loadModel = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, tfconv.loadGraphModel('https://tfhub.dev/tensorflow/tfjs-model/toxicity/1/default/1', { fromTFHub: true })];
            });
        });
    };
    ToxicityClassifier.prototype.loadTokenizer = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, use.loadTokenizer()];
            });
        });
    };
    ToxicityClassifier.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([this.loadModel(), this.loadTokenizer()])];
                    case 1:
    ...
    ToxicityClassifier.prototype.classify = function (inputs) {
        return __awaiter(this, void 0, void 0, function () {
            var encodings, indicesArr, flattenedIndicesArr, i, indices, values, modelInputs, labels;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
